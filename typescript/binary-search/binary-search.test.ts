...
describe("Binary Search", () => {
  ...
  it("identifies that a value is not included in the array", () => {
    const array = [1, 3, 4, 6, 8, 9, 11];
    expect(() => find(array, 7)).toThrow("Value not in array");
  });
  ...
  it.ignore(
    ...
    () => {
      const array = [1, 3, 4, 6, 8, 9, 11];
      expect(() => find(array, 0)).toThrow("Value not in array");
    },
  );
  ...
  it.ignore(
    ...
    () => {
      const array = [1, 3, 4, 6, 8, 9, 11];
      expect(() => find(array, 13)).toThrow("Value not in array");
    },
  );

  it.ignore("nothing is found in an empty array", () => {
    expect(() => find([], 1)).toThrow("Value not in array");
  });

  it.ignore("nothing is found when the left and right bounds cross", () => {
    expect(() => find([1, 2], 0)).toThrow("Value not in array");
  });
});
