...
describe('Transpose', () => {
  ...
  it.ignore('two characters in a row', () => {
    const expected = ['A', '1']
    expect(transpose(['A1'])).toEqual(expected)
  })

  it.ignore('two characters in a column', () => {
    const expected = ['A1']
  ...
  it.ignore('first line longer than second line', () => {
    const expected = [
      'TT',
      'hh',
      'ee',
  ...
  it.ignore('second line longer than first line', () => {
    const expected = [
      'TT',
      'hh',
      'ee',
