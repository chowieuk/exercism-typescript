...
You can submit your solution using the `exercism submit matrix.ts` command. This
command will upload your solution to the Exercism website and print the solution
page's URL.
