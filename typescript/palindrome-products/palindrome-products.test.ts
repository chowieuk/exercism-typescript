...
describe('Palindromes', () => {
  ...
  it.ignore('largest palindrome from single digit factors', () => {
    const palindromes = generate({ maxFactor: 9, minFactor: 1 })
  ...
  it.ignore('smallest palindrome from double digit factors', () => {
  ...
  it.ignore('largest palindrome from double digit factors', () => {
    const palindromes = generate({ maxFactor: 99, minFactor: 10 })
    const largest = palindromes.largest
  ...
  it.ignore('smallest palindrome from triple digit factors', () => {
  ...
  it.ignore('largest palindrome from triple digit factors', () => {
    const palindromes = generate({
      maxFactor: 999,
      minFactor: 100,
    })
  ...
  it.ignore('smallest palindrome from four digit factors', () => {
    const palindromes = generate({
      maxFactor: 9999,
      minFactor: 1000,
    })
  ...
  it.ignore('largest palindrome from four digit factors', () => {
    const palindromes = generate({
      maxFactor: 9999,
      minFactor: 1000,
    })
  ...
  it.ignore('empty result for smallest if no palindrome in range', () => {
    const palindromes = generate({
      maxFactor: 1003,
      minFactor: 1002,
    })
  ...
  it.ignore('empty result for largest if no palindrome in range', () => {
  ...
  it.ignore('error for smallest if min is more than max', () => {
    expect(() => {
      const palindromes = generate({
        maxFactor: 1,
        minFactor: 10000,
  ...
  it.ignore('error for largest if min is more than max', () => {
    expect(() => {
  ...
  it.ignore('smallest product does not use the smallest factor', () => {
    const palindromes = generate({
      maxFactor: 4000,
      minFactor: 3215,
    })
