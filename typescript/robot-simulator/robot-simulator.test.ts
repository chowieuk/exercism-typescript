...
describe('Robot', () => {
  describe('Create robot', () => {
    ...
    it.ignore('invalid robot bearing', () => {
      const robot = new Robot()
  ...
  describe('Rotating clockwise', () => {
    ...
    it.ignore('changes north to east', () => {
    ...
    it.ignore('changes east to south', () => {
      robot.place({ direction: 'east', x: 0, y: 0 })
    ...
    it.ignore('changes south to west', () => {
    ...
    it.ignore('changes west to north', () => {
      robot.place({ direction: 'west', x: 0, y: 0 })
  ...
  describe('Rotating counter-clockwise', () => {
    ...
    it.ignore('changes north to west', () => {
      robot.place({ direction: 'north', x: 0, y: 0 })
    ...
    it.ignore('changes west to south', () => {
      robot.place({ direction: 'west', x: 0, y: 0 })
    ...
    it.ignore('changes south to east', () => {
      robot.place({ direction: 'south', x: 0, y: 0 })
    ...
    it.ignore('changes east to north', () => {
      robot.place({ direction: 'east', x: 0, y: 0 })
  ...
  describe('Moving forward one', () => {
    ...
    it.ignore('advance when facing north', () => {
      robot.place({ direction: 'north', x: 0, y: 0 })
    ...
    it.ignore('advance when facing south', () => {
      robot.place({ direction: 'south', x: 0, y: 0 })
    ...
    it.ignore('advance when facing east', () => {
      robot.place({ direction: 'east', x: 0, y: 0 })
    ...
    it.ignore('advance when facing west', () => {
      robot.place({ direction: 'west', x: 0, y: 0 })
  ...
  describe('Follow series of instructions', () => {
    ...
    it.ignore('moving east and north from README', () => {
    ...
    it.ignore('moving west and north', () => {
    ...
    it.ignore('moving west and south', () => {
    ...
    it.ignore('moving east and north', () => {
    ...
    it.ignore('instruct many robots', () => {
