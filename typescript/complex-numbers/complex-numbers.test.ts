...
describe('Complex numbers', () => {
  ...
  it.ignore('Real part of a purely imaginary number', () => {
    const expected = 0
  ...
  it.ignore('Real part of a number with real and imaginary part', () => {
    const expected = 1
  ...
  it.ignore('Imaginary part of a purely real number', () => {
    const expected = 0
  ...
  it.ignore('Imaginary part of a purely imaginary number', () => {
    const expected = 1
  ...
  it.ignore('Imaginary part of a number with real and imaginary part', () => {
    const expected = 2
  ...
  it.ignore('Add purely real numbers', () => {
  ...
  it.ignore('Add purely imaginary numbers', () => {
  ...
  it.ignore('Add numbers with real and imaginary part', () => {
  ...
  it.ignore('Subtract purely real numbers', () => {
  ...
  it.ignore('Subtract purely imaginary numbers', () => {
  ...
  it.ignore('Subtract numbers with real and imaginary part', () => {
  ...
  it.ignore('Multiply purely real numbers', () => {
  ...
  it.ignore('Multiply imaginary unit', () => {
    const expected = new ComplexNumber(-1, 0)
  ...
  it.ignore('Multiply purely imaginary numbers', () => {
    const expected = new ComplexNumber(-2, 0)
  ...
  it.ignore('Multiply numbers with real and imaginary part', () => {
  ...
  it.ignore('Divide purely real numbers', () => {
  ...
  it.ignore('Divide purely imaginary numbers', () => {
    const expected = new ComplexNumber(0.5, 0)
  ...
  it.ignore('Divide numbers with real and imaginary part', () => {
  ...
  it.ignore('Absolute value of a positive purely real number', () => {
    const expected = 5
  ...
  it.ignore('Absolute value of a negative purely real number', () => {
    const expected = 5
    const actual = new ComplexNumber(-5, 0).abs
  ...
  it.ignore('Absolute value of a purely imaginary number with positive imaginary part', () => {
    const expected = 5
  ...
  it.ignore('Absolute value of a purely imaginary number with negative imaginary part', () => {
    const expected = 5
    const actual = new ComplexNumber(0, -5).abs
  ...
  it.ignore('Absolute value of a number with real and imaginary part', () => {
    const expected = 5
  ...
  it.ignore('Conjugate a purely real number', () => {
  ...
  it.ignore('Conjugate a purely imaginary number', () => {
  ...
  it.ignore('Conjugate a number with real and imaginary part', () => {
  ...
  it.ignore("Euler's identity/formula", () => {
    const expected = new ComplexNumber(-1, 0)
  ...
  it.ignore('Exponential of a purely real number', () => {
