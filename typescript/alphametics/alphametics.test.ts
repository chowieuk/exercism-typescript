...
describe('Solve the alphametics puzzle', () => {
  ...
  it.ignore('solution must have unique value for each letter', () => {
    const puzzle = 'A == B'
    expect(solve(puzzle)).toBeUndefined()
  })

  it.ignore('leading zero solution is invalid', () => {
    const puzzle = 'ACA + DD == BD'
    expect(solve(puzzle)).toBeUndefined()
  })

  it.ignore('puzzle with four letters', () => {
  ...
  it.ignore('puzzle with six letters', () => {
  ...
  it.ignore('puzzle with seven letters', () => {
  ...
  it.ignore('puzzle with eight letters', () => {
  ...
  it.ignore('puzzle with ten letters', () => {
